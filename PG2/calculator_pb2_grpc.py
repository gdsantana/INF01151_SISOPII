...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Max3 = channel.unary_unary(
                '/Calculator/Max3',
                request_serializer=calculator__pb2.Max3Request.SerializeToString,
                response_deserializer=calculator__pb2.SumReply.FromString,
                )
        self.DivMod = channel.unary_unary(
                '/Calculator/DivMod',
                request_serializer=calculator__pb2.DivModRequest.SerializeToString,
                response_deserializer=calculator__pb2.DivModReply.FromString,
                )
...
class CalculatorServicer(object):
    ...
    def Max3(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def DivMod(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Max3': grpc.unary_unary_rpc_method_handler(
                    servicer.Max3,
                    request_deserializer=calculator__pb2.Max3Request.FromString,
                    response_serializer=calculator__pb2.SumReply.SerializeToString,
            ),
            'DivMod': grpc.unary_unary_rpc_method_handler(
                    servicer.DivMod,
                    request_deserializer=calculator__pb2.DivModRequest.FromString,
                    response_serializer=calculator__pb2.DivModReply.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Max3(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/Max3',
            calculator__pb2.Max3Request.SerializeToString,
            calculator__pb2.SumReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def DivMod(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/DivMod',
            calculator__pb2.DivModRequest.SerializeToString,
            calculator__pb2.DivModReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
